...
const Footer = () => {
    return (
        ...
        <section className="w-full h-auto grid lg:grid-cols-5 md:grid-cols-3 lg:px-20 md:px-12 px-6 py-16 gap-7 md:gap-4 lg:gap-0">
            ...
            <Text as="h1" className="text-color4 font-semibold text-xl"> MaxPlay Innovations</Text>
            ...
            <div className="flex flex-col md:items-center gap-4 md:mt-8">
                ...
                <ul className="flex flex-col gap-2">
                            ...
                            <List  className="text-sm">
                                <Link to="/" className="text-color4 transition-all duration-300 hover:underline">  Home</Link>
                            </List>
                            <List  className="text-sm">
                                <Link to="/shop" className="text-color4 transition-all duration-300 hover:underline">  Shop</Link>
                            </List>
            ...
            <div className="flex flex-col md:items-center gap-4 md:mt-8">
                ...
                <ul className="flex flex-col md:ml-12 gap-2">
                            ...
                            <List  className="text-sm">
                                <Link to="/Terms" className="text-color4 transition-all duration-300 hover:underline">Terms & Conditions</Link>
                            </List>
            ...
            <div className="flex flex-col lg:items-center gap-4 md:mt-8">
                ...
                <List  className="text-sm">
                                <div className="text-color4 transition-all duration-300">  sales@maxplayinnovations.com</div>
                            </List>
                </ul>
            </div>
        ...
        <Text className="text-center bg-color4 text-white text-xs py-6 font-light">
            Copyright 2024. MaxPlayInnovations.com. All rights reserved.
        </Text>
    </footer>
